...
{
    public class InterceptGenericMethodsWithConstraintsClass<T1, T2> where T1 : T2 where T2 : new()
    {
        ...
        public T1 GenericReturnOriginalValueFromFirstParameter<T3, T4>(T1 a, T2 b, T3 c, T4 d) where T3 : struct where T4 : class
        {
            return a;
        }

        public T1 GenericReturnInterceptedValueFromFirstParameter<T3, T4>(T1 a, T2 b, T3 c, T4 d) where T3 : struct where T4 : class
        {
            return a;
        }

        public string GenericReturnOriginalParametersAsString<T3, T4>(T1 a, T2 b, T3 c, T4 d) where T3 : struct where T4 : class
        {
            return Helper.AsString(a, b, c, d);
        }

        public string GenericReturnInterceptedParametersAsString<T3, T4>(T1 a, T2 b, T3 c, T4 d) where T3 : struct where T4 : class
        {
            return Helper.AsString(a, b, c, d);
        }

        public string GenericReturnOriginalRefParametersAsString<T3, T4>(ref T1 a, ref T2 b, ref T3 c, ref T4 d) where T3 : struct where T4 : class
        {
            return Helper.AsString(a, b, c, d);
        }

        public string GenericReturnInterceptedRefParametersAsString<T3, T4>(ref T1 a, ref T2 b, ref T3 c, ref T4 d) where T3 : struct where T4 : class
        {
            return Helper.AsString(a, b, c, d);
        }

        public void GenericReturnOriginalOutParameters<T3, T4>(out T1 a, out T2 b, out T3 c, out T4 d, out T1[] e, out T2[] f, out T3[] g, out T4[] h, out List<T1> i, out List<T2> j, out List<T3> k, out List<T4> l) where T3 : struct where T4 : class
        {
            a = default(T1);
            b = default(T2);
            c = default(T3);
        ...
        public void GenericReturnInterceptedOutParameters<T3, T4>(out T1 a, out T2 b, out T3 c, out T4 d, out T1[] e, out T2[] f, out T3[] g, out T4[] h, out List<T1> i, out List<T2> j, out List<T3> k, out List<T4> l) where T3 : struct where T4 : class
        {
            a = default(T1);
            b = default(T2);
            c = default(T3);
