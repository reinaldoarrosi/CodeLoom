...
{
    internal class MethodWeaverHelper
    {
        ...
        public MethodDefinition CloneMethod(TypeDefinition typeDefinition, MethodDefinition originalMethod)
        {
        ...
        public TypeDefinition CreateBindingTypeDef(TypeDefinition typeDefinition, Type bindingType, string name, Collection<GenericParameter> genericParameters)
        {
            ...
            typeDef.CopyGenericParameters(genericParameters);
